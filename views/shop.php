                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <?php echo '<li data-filter=".'.$user->id.'">My Products</li>';?>
							<?php endif; ?>
				...
				<?php echo '<div class="col-lg-4 col-md-6 text-center '.$product->user_id.'">'; ?>
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><?php echo '<img style="width: 100%; max-width: 115px; height: auto;" src="/product_images/'.$product->product_image_name.'"/>'; ?></a>
						</div>
						<h3><?php echo $product->product_name ?></h3>
						<p class="product-price"><span>Per Unit</span> <?php echo $product->price ?> </p>
